...
$msg=" The booking has been successfully cancelled";
}
...
$msg=" The booking has been successfully processed";
}
...
<head>
	...
	<title>Cyborg's Car Rental | Admin | Manage Booking   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 style="color:OrangeRed;" class="page-title"><u>Manage Booking Requests</u></h2>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										...
										<th>#</th>
											...
											<th style="color:DeepPink;">Pick-up location</th>
											<th style="color:DeepPink;">From Date</th>
                                                                                        <th style="color:DeepPink;">Drop-off location</th>
											<th style="color:DeepPink;">To Date</th>
                                                                                        <th style="color:DeepPink;">Days</th>
...
<th style="color:DeepPink;">Driving License Number</th>											
									...
									<?php $sql = "SELECT tblusers.FullName,tblbrands.BrandName,tblvehicles.VehiclesTitle,tblbooking.plocation,tblbooking.FromDate,tblbooking.dlocation,tblbooking.ToDate,tblbooking.days,tblbooking.aadharno,tblbooking.drivinglicensenumber,tblbooking.driver,tblbooking.HomeService,tblbooking.message,tblbooking.VehicleId as vid,tblbooking.Status,tblbooking.id  from tblbooking join tblvehicles on tblvehicles.id=tblbooking.VehicleId join tblusers on tblusers.EmailId=tblbooking.userEmail join tblbrands on tblvehicles.VehiclesBrand=tblbrands.id  ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>	
										<tr>
											...
											<td><?php echo htmlentities($result->plocation);?></td>
                                                                                        <td><?php echo htmlentities($result->FromDate);?></td>
                                                                                        <td><?php echo htmlentities($result->dlocation);?></td>

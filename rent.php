...
$status=0;
$sql="INSERT INTO  tblrent(UserEmail,TOC,FUEL,RDOC,FEATURES,aadharno,drivinglicensenumber,HOMESERVICE,Status) VALUES(:email,:toc,:fuel,:rdoc,:features,:aadharno,:drivinglicensenumber,:homeservice,:status)";
...
<title>Car Rental Portal | Rent Your Car</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1 style="color:SandyBrown;"><u>Rent Your Car</u></h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a style="color:Cyan;" href="#">Home</a></li>
        <li style="color:Cyan;">Rent your car</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div style="background-color:LightYellow;" class="profile_wrap">
          <h5 style="color:MediumOrchid;" class="uppercase underline">Rent Your Car</h5>
          ...
          <div class="form-group">
              ...
              <input class="form-control white_bg" id="toc" pattern="[A-Za-z].{3,20}" title= "(*Note: Format-Min Count[3] and Max Count[20])" name="toc" required="" type="text">
            </div>
           <div class="form-group">
	   ...
	   <div class="form-group">
              ...
              <input class="form-control white_bg" id="aadharno" pattern="[2-9]{1}[0-9]{11}" title= "Your Aadhar Number isn't valid" required="" name="aadharno"  type="text">
            </div>
	   <div class="form-group">
              <label  style="color:Navy;" class="control-label">Driving License Number</label>
              <input class="form-control white_bg" id="drivinglicensenumber" pattern="[A-Z]{2}[0-9]{11}" title= "Your Driving License Number isn't valid" name="drivinglicensenumber"  required="" type="text">
            </div>
          <div class="form-group">
              <label  style="color:Navy;" class="control-label">Home Service</label>
              <input class="form-control white_bg" id="homeservice" name="homeservice" pattern="[A-Za-z]{3}" title= "(*Note: Make sure your format is correct.)" placeholder="Home Service(Yes/Nah)"  required="" type="text">
            </div>
          <div class="form-group">
...
<u><b style="color:Maroon;">Note- </b></u><i><p style="color:ForestGreen;"> The registered users have to mail the images of the vehicle within 2 days of filling the form, along with the identity proof card(Aadhar card), <u style="color:Red;"><b style="color:Red;"> if not the users candidature will be cancelled.</b></u></i></p>
</div>
      </div>
    </div>
  </div>

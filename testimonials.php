...
$msg=" Feedback has been successfully turned to inactive mode";
}
...
$msg=" Feedback has been successfully turned to active mode";
}
...
<head>
	...
	<title>Cyborg's Car Rental | Admin | Manage Feedback   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 style="color:OrangeRed;" class="page-title"><u>Manage Users Feedback</u></h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Users Feedback</div>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										...
										<th>#</th>
											...
											<th style="color:DeepPink;">Testimonials</th>

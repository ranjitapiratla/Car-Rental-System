...
<title>Cyborg's Car Rental | Net-banking</title>
<!--Bootstrap -->
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1 style="color:SandyBrown;"><u>Net-Banking</u></h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a style="color:Cyan;" href="#">Home</a></li>
        <li style="color:Cyan;">Net-Banking</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div style="background-color:LightYellow;" class="profile_wrap">
          <h5 style="color:MediumOrchid;" class="uppercase underline">Net-Banking</h5>
            <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
        else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
          
          <div class="form-group">
             <label style="color:ForestGreen;" for="banks">Choose a bank for payment:  </label>

...
<head>
	...
	<title>Cyborg's Car Rental | Admin | Manage Cars </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 style="color:OrangeRed;" class="page-title"><u>Manage Cars</u></h2>
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
										<th>#</th>
											<th style="color:DeepPink;">Vehicle Title</th>
											<th style="color:DeepPink;">Brand </th>
											<th style="color:DeepPink;">Price Per day</th>
											<th style="color:DeepPink;">Fuel Type</th>
											<th style="color:DeepPink;">Model Year</th>

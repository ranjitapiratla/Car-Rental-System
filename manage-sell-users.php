...
$eid=intval($_GET['eid']);
$status="2";
$sql = "UPDATE tblsell SET Status=:status WHERE  id=:eid";
...
$sql = "UPDATE tblsell SET Status=:status WHERE  id=:aeid";
$query = $dbh->prepare($sql);
$query -> bindParam(':status',$status, PDO::PARAM_STR);
$query-> bindParam(':aeid',$aeid, PDO::PARAM_STR);
$query -> execute();

$msg=" Request has been successfully confirmed";
}
...
<head>
	...
	<title>Cyborg's Car Rental | Admin | Manage Selling Requests</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 style="color:OrangeRed;" class="page-title"><u>Manage Users Requests(Selling)</u></h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Users Requests(Selling)</div>
...
<th style="color:DeepPink;">Aadhar Number</th>
									...
									<?php $sql = "SELECT tblusers.FullName,tblsell.UserEmail,tblsell.TOC,tblsell.FUEL,tblsell.RDOC,tblsell.FEATURES,tblsell.aadharno,tblsell.HOMESERVICE,tblsell.PostingDate,tblsell.Status,tblsell.id from tblsell join tblusers on tblusers.Emailid=tblsell.UserEmail";
$query = $dbh -> prepare($sql);
$query->execute();
...
echo htmlentities('Confirmed');
 	...
 	echo htmlentities('Cancelled');
										...
										<td><a href="manage-sell-users.php?aeid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Confirm this booking')"> Confirm</a> /


<a href="manage-sell-users.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
</td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>

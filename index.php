...
<!-- Banners -->
<div class="banner">
<img class="banner-image" src="assets/images/banner4.jpg">
</div>
<!-- /Banners --> 


<!-- Resent Cat-->
<section class="section-padding MistyRose bg">
  <div class="container">
    <div class="section-header text-center">
      <h2 style="color:MediumVioletRed;"><u>You're better off driving our way.</u></h2>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Cyborg's Car</a></li>
        </ul>
      </div>
